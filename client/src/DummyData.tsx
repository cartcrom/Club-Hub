...
export const DD_fake_clubs = new Map<string, Club>();
...
const test_club1 = new Club("Ice Cream Club", "id1", "A club for people who like Ice Cream", ice, john, [], "Cal Poly SLO", ["ice", "cream", "creamed", "iced"], undefined, [], []);
...
const test_club2 = new Club("John Club", "id2", "A club for people who like John", john, john, [], "Cal Poly SLO", ["john", "religion"], undefined, [], []);
...
const test_club3 = new Club("John Club 2", "id3", "A club for people who like John even more", john, john, [], "Cal Poly SLO", ["john", "jon", "jonathan", "J"], undefined, [], []);
...
const test_club4 = new Club("Rockclimbing Club", "id4", "Climb all of the rocks", john, john, [], "Cal Poly SLO", ["rocks", "climbing", "outdoor", "athletic", "recreation"], undefined, [], []);
